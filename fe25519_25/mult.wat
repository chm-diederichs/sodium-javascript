(module
  ...
  (func $mul (export "mul") (param $h i32) (param $f i32) (param $g i32)
    ...
    (i64.or)
    (tee_local $tmp)
    (i64.shr_u (get_local $tmp) (i64.const 2))
    (i64.or)
    (tee_local $tmp)
    (i64.shr_u (get_local $tmp) (i64.const 4))
    (i64.or)
    (tee_local $tmp)
    (i64.shr_u (get_local $tmp) (i64.const 8))
    (i64.or)
    (tee_local $tmp)
    (i64.shr_u (get_local $tmp) (i64.const 16))
    (i64.or)
    (get_local $f0)
    (i64.or)
    (set_local $f0)
  ...
  (func $sc25519_reduce (export "sc25519_reduce") (param $s i32) (param $a i32) (param $b i32) (param $c i32)
    (local $s0 i64)
    (local $s1 i64)
    (local $s2 i64)
    (local $s3 i64)
